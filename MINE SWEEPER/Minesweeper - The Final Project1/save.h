void saveGame(char arr[200][200], char arr2[200][200], int numberOfMines, int numberOfMoves, int numberOfFlags, int numberOfQuestionMarks, time_t sec1, int n, int m){
    int i,j;
